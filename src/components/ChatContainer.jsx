...
export default function ChatContainer({ currentChat, socket }) {
    ...
    const getCurrentChatId = async () => {
      try {
        if (currentChat) {
          ...
          // You may want to use chatId for something, but this function doesn't explicitly do anything with it right now
        }
      } catch (error) {
  ...
  if (!currentChat) {
    return null; // Render nothing if there's no currentChat defined
  }
